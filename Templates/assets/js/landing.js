...
if ($('.landing-projects-carousel')) {
    $('.landing-projects-carousel').slick({
        slidesToShow: 1.5,
        infinite: false,
        prevArrow: '<button type="button" class="slick-nav-btn"><img src="/media/images/arrow.png" style="width:25px"></button>',
        nextArrow: '<button type="button" class="slick-nav-btn"><img src="/media/images/arrow2.png" style="width:25px"></button>',
